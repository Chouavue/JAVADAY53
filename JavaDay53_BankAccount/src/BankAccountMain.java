...
public class BankAccountMain {
        ...
        account.add(new BankAccount("Sharon",3000, 0 ));
        account.add(new BankAccount("William",250, 1 ));
        account.add(new BankAccount("John",400, 3 ));



        System.out.println("Hello world! Welcome to the Bank of Choua!");
